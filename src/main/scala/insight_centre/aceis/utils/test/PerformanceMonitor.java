package insight_centre.aceis.utils.test;

import com.csvreader.CsvWriter;
import insight_centre.aceis.io.streams.csparql.CSPARQLSensorStream;
...
public class PerformanceMonitor implements Runnable {
	...
	public PerformanceMonitor(Map<String, String> queryMap, long duration, int duplicates, String resultName, ContainerController cc)
			throws Exception {
	    this.cc = cc;
		qMap = queryMap;
	...
	public void run() {
		...
		while (!stop) {
			try {
				//logger.info("PM ==> " + (System.currentTimeMillis() - this.globalInit)/1000 , duration/1000);
